...
export const HIGHLIGHTED_ARTICLES_RFKID = 'daikin_search_home_highlight_articles';
...
export const HOMEHIGHLIGHTED_WIDGET_ID = 'daikin_search_home_highlight_articles';
